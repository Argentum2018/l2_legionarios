...
##                   Configuración                       ##
###########################################################
$server_name = 'L2 Legionarios'; // Server Nombre
$server_chronicle = 'Interlude'; // Server Chronicle
$server_url = 'ed.ns.cloudflare.com'; // Introduzca exactamente la URL donde se encuentra este site (por ejemplo: www.l2server.com)
...
$dpage['bosstt'] = 0; // Boss Status
$dpage['bossjl'] = 0; // Boss Jewelry Location
$dpage['galler'] = 0; // Galeria
$dpage['olyall'] = 0; // Olympiad - Histórico de heroes
$dpage['olyher'] = 0; // Olympiad - Heroes atuais
$dpage['olyrak'] = 0; // Olympiad - Ranking
$dpage['csiege'] = 0; // Castle & Siege
$dpage['toppvp'] = 0; // Top PvP
$dpage['toppkp'] = 0; // Top Pk
$dpage['toponl'] = 0; // Top Online
$dpage['toplvl'] = 0; // Top Level
$dpage['topadn'] = 0; // Top Adena
$dpage['topcla'] = 0; // Top Clan
